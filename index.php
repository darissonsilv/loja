...
<div class="container">
    ...
    <div class="corpoProduto">
        <div class="imgProduto">
            <img src="/loja/assets/img/produto-1.png" alt="" class="produtoMiniatura">
        </div>
    <div class="titulo">
        <p> Gol volkswagen</p>
        <h2>R$ 25.900</h2>
    ...
    <div class="corpoProduto">
        <div class="imgProduto">
            <img src="/loja/assets/img/produto-2.png" alt="" class="produtoMiniatura">
        </div>
    <div class="titulo">
        <p> Gol volkswagen</p>
        <h2>R$ 25.900</h2>
    ...
    <div class="corpoProduto">
        <div class="imgProduto">
            <img src="/loja/assets/img/produto-3.jpg" alt="" class="produtoMiniatura">
        </div>
    <div class="titulo">
        <p> Gol volkswagen</p>
        <h2>R$ 25.900</h2>
    ...
    <div class="corpoProduto">
        <div class="imgProduto">
            <img src="/loja/assets/img/produto-4.png" alt="" class="produtoMiniatura">
        </div>
    <div class="titulo">
        <p> Gol volkswagen</p>
        <h2>R$ 25.900</h2>
    ...
    <div class="barraLateral">
        ...
        <div class="item-carrinho">
            <div class="linha-da-imagem">
                <img src="/loja/assets/img/produto-1.png" alt="" class="img-carrinho">
            </div> 
